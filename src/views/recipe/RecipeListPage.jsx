...
import {getTypesRecipeNextPage, getTypesRecipesError, getTypesRecipesStatus, selectTypesAllRecipes} from '../../redux/store/typesSlice'
...

            {
              nextPageLink?.length > 0 && (
                <div className="next-button">
                  <button className="next-page-btn" type="button" onClick={() => dispatch(fetchTypesRecipes({typeData: {}, nextPageLink}))}>Next Page</button>
                </div>
              )
            }
