...
import { AiFillFire, AiOutlineCheckSquare, AiOutlineFieldTime } from 'react-icons/ai';
    ...
    <main className='recipe-single-page custom-min-h pt-[4px]'>
      <section className='recipe-single'>
        <div className='container recipe-single-top'>
          <button type='button' onClick={() => navigate(-1)} className='back-btn flex items-center font-semibold mb-4'>
                ...
                <div className="block-list">
                  {
                    tempImages?.map((image, idx) => (
                      <div key={idx} className='block-list-item-wrapper'>
                        <a href={image[1].url} data-lightbox="images" className='block-list-item'>
