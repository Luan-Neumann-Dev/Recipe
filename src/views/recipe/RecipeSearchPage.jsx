...
import { getRecipesError, getRecipesStatus, getSearchQuery, selectSearchResult, getRecipesNextPage, clearSearch } from '../../redux/store/recipesSlice';
          ...
          <div className="container">
            {
              searchRecipes?.length > 0 && (
                <button type='button' className='clear-btn' onClick={() => dispatch(clearSearch())}>
...

            {
              nextPageLink?.length > 0 && (
                <div className="next-button">
                  <button className="next-page-btn" type='button' onClick={() => dispatch(fetchSearchRecipe({queryText: "", nextPageLink: nextPageLink}))}>
                    Next Page
                  </button>
                </div>
              )
